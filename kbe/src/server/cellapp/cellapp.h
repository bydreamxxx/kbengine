...
public:
	...
	*/
	...
	int navmeshRaycast(std::string path, int layer, uint16 flags, const Position3D& start, const Position3D& end, std::vector<Position3D>& hitPos);
	static PyObject* __py_navmeshRaycast(PyObject* self, PyObject* args);
