...
NETWORK_INTERFACE_DECLARE_BEGIN(CellappInterface)
	...
	CELLAPP_MESSAGE_DECLARE_STREAM(onUpdateDataFromClientOnParent,					NETWORK_VARIABLE_MESSAGE)
	CELLAPP_MESSAGE_DECLARE_STREAM(onUpdateDataFromClientForControlledEntityOnParent, NETWORK_VARIABLE_MESSAGE)
